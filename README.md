...
Planting: Go to Properties -> Farms. Press P, select a seed, and choose a plot.

Watering: Plants die if water hits 0%. Check your water levels daily!

Weather Risks: Heavy Winds or Rain can kill crops. Install a Greenhouse [GH] to protect them.
...
Install a Table: You must buy a Lab Table and install it (the game will auto-detect it when you try to use the lab).

Ingredients: Buy raw materials (e.g., Coca Leaves) from the market.

Process: Select a recipe. It takes 10 Raw Ingredients to make 1 Product.
...
Stage 1-4: Increases speed (Stage 4 = 1000x output).

Holo Strips: 2x Multiplier.

Watermarks: 1.5x Multiplier.
...
Overclocking: Install a Liquid Cooling Kit to triple (3x) your mining speed.
...
Crops grow (or die from weather).

Miners mine crypto.

Printers print cash.

Bills: You pay electricity costs (unless you own a Solar Panel).
...
Interest: Interest accumulates daily every time you sleep.
...
Assets: The value of every Lab, Plot, and Server Room you own.
